...
namespace ss
{
  namespace multi
  {
    namespace impl
    {
      ...
      // TODO 9:06 PM Wednesday, October 29, 2025. Unnecessary.
/*
...
*/
      ...
      // TODO 9:04 PM Wednesday, October 29, 2025. In progress.
      // TODO 8:19 PM Thursday, October 30, 2025. Test.
...
// SS << "   component_0 = " << component_0 << std::endl;
          ...
          for(auto i{1zu}; i < N; ++i)
          {
            ...
            if(component_i > 0)
            {
              initial_count += component_i;
// SS << "       [" << i << "]\n";
// SS << "       component_i = " << component_i << std::endl;
